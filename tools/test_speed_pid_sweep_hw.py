...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('port',nargs='?',default='/dev/ttyUSB0'); ap.add_argument('--target',type=float,default=300); ap.add_argument('--run-s',type=float,default=1.2); ap.add_argument('--stop-s',type=float,default=.8); ap.add_argument('--hz',type=float,default=18); ap.add_argument('--max-erpm',type=float,default=900); ap.add_argument('--max-current',type=float,default=1.2); ap.add_argument('--out',default='tools/results_speed_pid'); ap.add_argument('--quick',action='store_true'); ap.add_argument('--gains',default='',help='semicolon-separated kp,ki,kd triples'); ap.add_argument('--targets',default='',help='comma-separated positive ERPM magnitudes'); ap.add_argument('--repeats',type=int,default=1); a=ap.parse_args()
